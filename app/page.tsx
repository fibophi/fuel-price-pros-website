        ...
        <section className="py-16 px-4 bg-navy text-white">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl lg:text-2xl leading-relaxed text-blue-100">
              We help growing fleets win with buying power and tactics once reserved for the big guys. We've worked
              inside the industry and know where the real dollars are hiding.
            </p>
          </div>
        </section>

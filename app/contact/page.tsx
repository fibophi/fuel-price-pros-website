            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full bg-orange hover:bg-orange/90 text-lg py-3">
                    Get Started
                  </Button>
                </form>
              </CardContent>
            ...
            <div className="space-y-8">
              ...
              <Card className="bg-gradient-to-br from-navy to-navy/90 text-white">
                ...
                <CardContent>
                  ...
                  <Button className="w-full bg-orange hover:bg-orange/90">Download Free Kit</Button>
                </CardContent>
              </Card>
